...
class OGBDataset(InMemorySSTreeDataset):
    ...
    def __init__(self,
        ...
        self._simple = simple
        self._n_jobs = n_jobs
        super(OGBDataset, self).__init__(root,
                                         transform,
                                         pre_transform,
                                         pre_filter,
                                         max_dim=2,
    ...
    def processed_file_names(self):
        return [f'{self.name}_sstrees.pt', f'{self.name}_idx.pt', f'{self.name}_tasks.pt']
    ...
    def process(self):
        ...
        sstrees, _, _ = convert_graph_dataset_with_rings(dataset,
        ...
        torch.save(self.collate(sstrees, self.max_dim), self.processed_paths[0])
