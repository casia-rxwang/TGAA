...
class CSLDataset(InMemorySSTreeDataset):
    ...
    def __init__(self,
        ...
        self._n_jobs = n_jobs
        super(CSLDataset, self).__init__(root,
                                         transform,
                                         pre_transform,
                                         pre_filter,
                                         max_dim=2,
    ...
    def process(self):
        ...
        sstrees, _, _ = convert_graph_dataset_with_rings(new_data,
        ...
        torch.save(self.collate(sstrees, 2), path)
