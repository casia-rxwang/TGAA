...
from exp.model_tool import create_dataset, create_model, create_scheduler, load_model, save_model, load_curve, save_curve


def main(args):
    """The common procedure for all experiments."""
    # set device
    ...
    if args.exp_mode == 'resume' and model_exist and curve_exist:
        ...
        train_curve, valid_curve, test_curve = load_curve(curve_path, start_epoch)
    ...
    if not args.untrained:
        for epoch in range(start_epoch + 1, args.epochs + 1):
            ...
            # evaluate model
            print('Evaluating...')
            if epoch == start_epoch + 1 or epoch % args.train_eval_period == 0:
    ...
    curves = {
        ...
        'best': best_val_epoch - 1
    }

    msg = (f'=========== Result ===========\n'
           f'Dataset:        {args.dataset}\n'
           f'----------- Best epoch -----------\n'
           f'Train:          {train_curve[best_val_epoch - 1]}\n'
           f'Validation:     {valid_curve[best_val_epoch - 1]}\n'
           f'Test:           {test_curve[best_val_epoch - 1]}\n'
